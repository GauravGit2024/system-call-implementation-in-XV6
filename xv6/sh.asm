...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac9:	ff 24 85 d0 13 00 00 	jmp    *0x13d0(,%eax,4)
...
atoi(const char *s)
{
  ...
  while('0' <= *s && *s <= '9')
     ...
     dc7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     dce:	00 
     dcf:	90                   	nop
    n = n*10 + *s++ - '0';
...
memmove(void *vdst, const void *vsrc, int n)
{
  ...
  dst = vdst;
     ...
     e06:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     e0d:	00 
     ...
     fd9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1106:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    110d:	00 
  ...
  write(fd, &c, 1);
    ...
    1153:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
          s = "(null)";
    1158:	ba af 13 00 00       	mov    $0x13af,%edx
        while(*s != 0){
